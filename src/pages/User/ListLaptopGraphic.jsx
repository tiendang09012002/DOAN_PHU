        ...
        <div className="container">
          ...
          <div className="filter">
            <div className="filter-options">
              <button className="option">
                ...
                >
                  <path
                    d="M0 1.17391C0 0.862572 0.105357 0.563982 0.292893 0.343831C0.480429 0.12368 0.734784 0 1 0H21C21.2652 0 21.5196 0.12368 21.7071 0.343831C21.8946 0.563982 22 0.862572 22 1.17391C22 1.48525 21.8946 1.78384 21.7071 2.00399C21.5196 2.22415 21.2652 2.34783 21 2.34783H1C0.734784 2.34783 0.480429 2.22415 0.292893 2.00399C0.105357 1.78384 0 1.48525 0 1.17391ZM3.33333 9C3.33333 8.68866 3.43869 8.39007 3.62623 8.16992C3.81376 7.94977 4.06812 7.82609 4.33333 7.82609H17.6667C17.9319 7.82609 18.1862 7.94977 18.3738 8.16992C18.5613 8.39007 18.6667 8.68866 18.6667 9C18.6667 9.31134 18.5613 9.60993 18.3738 9.83008C18.1862 10.0502 17.9319 10.1739 17.6667 10.1739H4.33333C4.06812 10.1739 3.81376 10.0502 3.62623 9.83008C3.43869 9.60993 3.33333 9.31134 3.33333 9ZM7.33333 16.8261C7.33333 16.5147 7.43869 16.2162 7.62623 15.996C7.81376 15.7759 8.06812 15.6522 8.33333 15.6522H13.6667C13.9319 15.6522 14.1862 15.7759 14.3738 15.996C14.5613 16.2162 14.6667 16.5147 14.6667 16.8261C14.6667 17.1374 14.5613 17.436 14.3738 17.6562C14.1862 17.8763 13.9319 18 13.6667 18H8.33333C8.06812 18 7.81376 17.8763 7.62623 17.6562C7.43869 17.436 7.33333 17.1374 7.33333 16.8261Z"
                    fill="#E82F35"
                  />
                </svg>
                Bộ lọc
              ...
              <button className="option">
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M7.5 8L0 0H15L7.5 8Z" fill="#E82F35" />
                </svg>
              </button>
              <button className="option">
                Giá
            ...
            <div className="sort-options">
              <button className="sort-button">
                ...
                >
                  <path
                    d="M1.875 5.75H10.625M1.875 12H10.625M1.875 18.25H10.625"
                    stroke="#E82F35"
                    strokeWidth={2}
                    strokeLinecap="round"
                  />
                  <path
                    d="M19.3755 22L23.1255 18.25M19.3755 22L15.6255 18.25M19.3755 22V2M19.3755 2L15.6255 5.75M19.3755 2L23.1255 5.75"
                    stroke="#E82F35"
                    strokeWidth={2}
                  />
                </svg>
                ...
                >
                  <path
                    d="M7.625 7.92843L0.125 0.0712891H15.125L7.625 7.92843Z"
                    fill="black"
                  />
                </svg>
              </button>
          ...
          <div className="list-products">
            ...
            <div>
              <div className="container">
                <div className="row">
                  <div id="products" className="list-unstyled flex-wrap">
...
export default ListLaptopGraphic;
